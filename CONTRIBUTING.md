# Contributing to spotforecast2

Thank you for your interest in contributing to spotforecast2! This document provides guidelines and requirements for contributing to the project.
...
def get_cpe_identifier(version: str = "*") -> str:
    """Generates the CPE 2.3 identifier for the spotforecast2 project.

    This function constructs a Common Platform Enumeration (CPE) 2.3 formatted
    string that uniquely identifies the spotforecast2 software.
...
By contributing to spotforecast2, you agree that your contributions are licensed under AGPL-3.0-or-later. Include the SPDX header in all new files you create.
