...
class TestMainFunction:
    ...
    def test_parameter_validation(self):
        ...
        with patch("spotforecast2.processing.n2n_predict_with_covariates.fetch_data"):
            with patch(
                "spotforecast2.processing.n2n_predict_with_covariates.get_start_end"
            ):
                with patch(
                    "spotforecast2.processing.n2n_predict_with_covariates.basic_ts_checks"
                ):
                    with patch(
                        "spotforecast2.processing.n2n_predict_with_covariates.agg_and_resample_data"
                    ):
