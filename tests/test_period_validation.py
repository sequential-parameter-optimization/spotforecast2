...
class TestPeriodConfiguration:
    ...
    def test_daily_period_n_periods_12_vs_24(self):
        ...
        # Validate shapes
        assert features_12.shape == (24, 12), "12 basis functions should produce 12 features"
        assert features_24.shape == (24, 24), "24 basis functions should produce 24 features"
    ...
    def test_period_configuration_rationale(self):
        ...
        for r in ratios:
            print(f"{r['name']:10s}: {r['n_periods']:2d} basis functions for {r['range_size']:3d} values (ratio: {r['ratio']:.1f}:1)")
    ...
    def test_daily_period_captures_key_patterns(self):
        ...
        for label, hour in test_hours.items():
            ...
            print(f"{label:15s} (hour {hour:2d}): basis [{top_3_indices[0]:2d}]={top_3_values[0]:.3f}, "
        ...
        assert unique_peaks == 12, "All 12 basis functions should be peak for different hours"
    ...
    def test_comparison_with_alternative_config(self):
        ...
        print(f"Difference: {total_features_24 - total_features_12} additional features (+{100*(total_features_24 - total_features_12)/total_features_12:.1f}%)")
