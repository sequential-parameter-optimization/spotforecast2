...
class TestModelDirParameter:
    ...
    def test_model_dir_creation(self, temp_model_dir):
        ...
        from spotforecast2.processing.n2n_predict_with_covariates import _ensure_model_dir
...
class TestPersistenceFunctions:
    ...
    @patch("spotforecast2.processing.n2n_predict_with_covariates.dump")
    ...
    @patch("spotforecast2.processing.n2n_predict_with_covariates.load")
    @patch("spotforecast2.processing.n2n_predict_with_covariates.dump")
