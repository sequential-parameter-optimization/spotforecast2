...
class TestEnsureModelDir:
    ...
    def test_create_new_directory(self, temp_model_dir):
        ...
        from spotforecast2.processing.n2n_predict import _ensure_model_dir
...
class TestGetModelFilepath:
    ...
    def test_correct_filepath_format(self, temp_model_dir):
        ...
        from spotforecast2.processing.n2n_predict import _get_model_filepath
...
class TestSaveForecasters:
    ...
    def test_save_single_forecaster(self, mock_dump, temp_model_dir):
        ...
        from spotforecast2.processing.n2n_predict import _save_forecasters
    ...
    @patch("spotforecast2.processing.n2n_predict.dump", side_effect=OSError("Permission denied"))
...
class TestLoadForecasters:
    ...
    def test_load_single_forecaster(self, mock_dump, mock_load, temp_model_dir):
        ...
        from spotforecast2.processing.n2n_predict import (
            _load_forecasters,
            _save_forecasters,
        )
    ...
    def test_load_missing_models(self, temp_model_dir):
        ...
        from spotforecast2.processing.n2n_predict import _load_forecasters
...
class TestModelDirectoryExists:
    ...
    def test_directory_exists(self, temp_model_dir):
        ...
        from spotforecast2.processing.n2n_predict import _model_directory_exists
