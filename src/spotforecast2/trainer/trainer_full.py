...
def search_space_lgbm(trial: Any) -> dict:
    ...
    Examples:
        >>> from spotforecast2.trainer.trainer_full import search_space_lgbm
...
def search_space_xgb(trial: Any) -> dict:
    ...
    Examples:
        >>> from spotforecast2.trainer.trainer_full import search_space_xgb
    ...
    **kwargs: Any,
    ...
    Examples:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch("spotforecast2.trainer.trainer_full.get_last_model",
                       return_value=(-1, None)):
                with patch("spotforecast2.trainer.trainer_full.train_new_model") as m:
